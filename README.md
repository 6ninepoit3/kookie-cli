# 🥠 kookie-cli - A Simple Way to Store Secrets Securely
...
Kookie works on both Unix-based systems (like Linux and macOS) and Windows. Here’s what you need:
...
3. **Retrieve a secret:**
   ...
   - Click “View” to see the stored information.
